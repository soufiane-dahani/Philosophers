...
{
    if (data->forks) sem_close(data->forks);
    if (data->print_sem) sem_close(data->print_sem);
    if (data->meal_sem) sem_close(data->meal_sem);
    if (data->death_sem) sem_close(data->death_sem);
    if (data->d) sem_close(data->d);
    if (data->m) sem_close(data->m);
